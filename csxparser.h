...
public:
    ...
    void importCsx(std::string origCsxFilename, std::string tlCsxFilename, std::deque<std::string> utfFilenames, const char *customSpace, bool ignoreExactLineBreaks);
